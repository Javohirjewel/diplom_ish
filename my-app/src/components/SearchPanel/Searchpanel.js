...
function SearchPanel(props) {
  let{darkmode, inpSearch, setText, text} = props
  return (
    <div className={darkmode ? "SearchPanel SearchPanel__dark": "SearchPanel"}>
      <div className="SearchPanel__input">
        <label>
          <input value = {text} onChange={inpSearch} className="input" typeof='submit' placeholder="Markazlarni nomi bo’yicha qidirish"/> 
        </label>        
